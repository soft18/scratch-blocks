...
Blockly.Blocks['control_forever'] = {
  ...
  init: function() {
    this.jsonInit({
      "id": "control_forever",
      "message0": LOCAL.blocks_control_forever,
...
Blockly.Blocks['control_repeat'] = {
  ...
  init: function() {
    this.jsonInit({
      "id": "control_repeat",
      "message0": LOCAL.blocks_control_repeat,
      "message1": "%1", // Statement
      "message2": "%1", // Icon
      "lastDummyAlign2": "RIGHT",
      "args0": [
...
Blockly.Blocks['control_if'] = {
  ...
  init: function() {
    this.jsonInit({
      "type": "control_if",
      "message0": LOCAL.blocks_control_if,
      "message1": "%1", // Statement
      "args0": [
        {
          "type": "input_value",
...
Blockly.Blocks['control_if_else'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": LOCAL.blocks_control_if_else_if,
      "message1": "%1",
      "message2": LOCAL.blocks_control_if_else_else,
      "message3": "%1",
      "args0": [
        {
          "type": "input_value",
...
Blockly.Blocks['control_stop'] = {
  ...
  init: function() {
    ...
    var stopDropdown = new Blockly.FieldDropdown(function() {
      ...
      return [[LOCAL.blocks_control_stop_all, ALL_SCRIPTS],
        [LOCAL.blocks_control_stop_this, THIS_SCRIPT],
        [LOCAL.blocks_control_stop_other, OTHER_SCRIPTS]
      ];
    }, function(option) {
...
Blockly.Blocks['control_wait'] = {
  ...
  init: function() {
    this.jsonInit({
      "id": "control_wait",
      "message0": LOCAL.blocks_control_wait,
      "args0": [
        {
          "type": "input_value",
          "name": "DURATION"
...
Blockly.Blocks['control_wait_until'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": LOCAL.blocks_control_wait_until,
      "args0": [
        {
          "type": "input_value",
          "name": "CONDITION",
...
Blockly.Blocks['control_repeat_until'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": LOCAL.blocks_control_repeat_until,
      "message1": "%1",
      "message2": "%1",
      "lastDummyAlign2": "RIGHT",
      "args0": [
...
Blockly.Blocks['control_start_as_clone'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": LOCAL.blocks_control_start_as_clone,
      "args0": [
      ],
      "category": Blockly.Categories.control,
...
Blockly.Blocks['control_create_clone_of'] = {
  ...
  init: function() {
    this.jsonInit({
      "id": "control_start_as_clone",
      "message0": LOCAL.blocks_control_create_clone_of,
      "args0": [
        {
          "type": "input_value",
          "name": "CLONE_OPTION"
...
Blockly.Blocks['control_delete_this_clone'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": LOCAL.blocks_control_delete_this_clone,
      "args0": [
      ],
      "category": Blockly.Categories.control,
      "extensions": ["colours_control", "shape_end"]
